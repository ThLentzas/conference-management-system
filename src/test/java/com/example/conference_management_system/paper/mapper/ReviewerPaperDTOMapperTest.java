...
class ReviewerPaperDTOMapperTest {
    private ReviewerPaperDTOMapper underTest;

    @BeforeEach
    void setup() {
        underTest = new ReviewerPaperDTOMapper();
    }

    @Test
    void shouldMapPaperToReviewerPaperDTO() {
        ...
        ReviewerReviewDTO reviewerReviewDTO = new ReviewerReviewDTO(1L, 1L, LocalDate.now(), "comment", 9.1, "full name");

        ReviewerPaperDTO expected = new ReviewerPaperDTO(
                1L,
